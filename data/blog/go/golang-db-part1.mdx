---
title: 'Connect to SQL Database with Go'
date: '2022-01-13'
tags: ['go', 'database']
draft: false
summary: 'ในภาษา Go ถ้าต้องการเขียนโปรแกรมต่อกับระบบฐานข้อมูล สามารถใช้ standard library ที่ Go เตรียมไว้ให้ได้เลย'
---

# Connect to SQL Database with Go

ในภาษา Go ถ้าต้องการเขียนโปรแกรมต่อกับระบบฐานข้อมูล สามารถใช้ standard library ที่ Go เตรียมไว้ให้ได้เลย ซึ่งก็คือ [database/sql](https://pkg.go.dev/database/sql)
