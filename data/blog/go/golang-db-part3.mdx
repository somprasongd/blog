---
title: 'Connect to SQL Database with GORM'
date: '2022-01-17'
tags: ['go', 'database', 'gorm']
draft: false
summary: 'หลายๆ คนอาจไม่ถนัดการใช้ภาษา SQL หรืออยากหาอะไรมาช่วยให้ทำงานง่ายขึ้น มาลองใช้ ORM library กัน'
