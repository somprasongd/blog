---
title: 'Distributed Logging: ตอนที่ 3 Promtail ดึง Log จาก Kubernetes'
date: '2025-07-04'
lastmod: '2025-07-04'
...
[จากตอนที่แล้ว](https://somprasongd.work/blog/go/distributed-logging-2) รันด้วย Docker Compose ถ้าเปลี่ยนไปรันใน Kubernetes แล้วใช้ **label-based log filtering** ใน Promtail สำหรับดึง log ของเฉพาะ Pod/Container ที่ต้องการ จะต้องปรับแต่งหลักๆ ดังนี้
