---
title: 'การทดสอบระบบโดยใช้ Mocha'
date: '2016-12-20'
tags: ['nodejs', 'test']
draft: false
summary: 'การทดสอบระบบโดยใช้ Mocha'
---
...
**ติดตั้ง:** `$ npm i mocha --save-dev` ใช้ `-dev` เพราะไม่ต้องการใช้ใน production
...
ก็สร้างไฟล์ `utils.test.js` ขึ้นมา ซึ่งจะสร้าง test case ขึ้นโดยใช้ `it('message', () => {});` ซึ่งถ้าผลลัพธ์ไม่ได้อย่างที่ต้องการก็ให้ `throw new Error('Message');` ออกไป
...
**ติดตั้ง:** `$ npm i expect --save-dev` ใช้ -dev เพราะไม่ต้องการใช้ใน production
...
**ติดตั้ง:** `$ npm i supertest --save-dev` ใช้ -dev เพราะไม่ต้องการใช้ใน production
...
it('should return user object response', (done) => {
  request(app)
    ...
    .expect(200)
    .expect((res) => {
      // เปลี่ยนส่วนนี้เป็น callback function รับ response object มา
...
ปกติถ้ารัน mocha \*_/_.test.js โปรแกรมจะปริ้นข้อความต่อกันมาหมด ทำให้แยกยากวันแต่ละบรรทัดเป็นการทดสอบของไฟล์ไหน หรือฟังก์ชันไหน เราจะใช้ `decribe('message', () => {});` มาแบ่งกลุ่มกัน ตัวอย่าง

แบบไม่ใช้ describe()

<div className="flex justify-center">
  <div>![No describe()](/static/images/nodejs/mocha/no_describe.PNG)</div>
</div>
...
<div className="flex justify-center">
  <div>![With describe()](/static/images/nodejs/mocha/with_describe.PNG)</div>
</div>
